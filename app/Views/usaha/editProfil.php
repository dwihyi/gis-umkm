            ...
            <div class="col-12 col-md-10 col-lg-10">
              <div class="card">
                <div class="card-header">
                  <a href="<?=base_url('usaha/myprofil') ?>" class="btn btn-icon icon-left btn-warning"><i class="fa fa-arrow-left"></i> Kembali</a>
                </div>
                <div class="col-lg-8">
                  <?php
                ...
                <div class="card-body">
                  <form class="needs-validation" novalidate="" enctype= "multipart/form-data" method="post" action="<?= base_url('usaha/update/'.$tb_umkm['id_umkm']); ?>">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">NIB</label>
                        <div class="col-sm-9">
                          <input type="number" class="form-control" required="" name="nib" value="<?=$tb_umkm['nib'] ?>">
                    ...
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Nama Pemilik</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" required="" name="nama_pemilik" value="<?= user()->username?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Nama Usaha</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" required="" name="nama_usaha" value="<?=$tb_umkm['nama_usaha'] ?>">
                            <div class="invalid-feedback">
                      ...
                      <label class="col-sm-3 col-form-label">Sektor Usaha</label>
                        <div class="col-sm-9">
                            <select name="id_sektor" class="form-control">
                              <option value="<?= $tb_umkm['id_sektor'] ?>"><?= $tb_umkm['sektor'] ?></option>
                    ...
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Alamat</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" required="" value="<?=$tb_umkm['alamat'] ?>" name="alamat">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Kecamatan</label>
                        ...
                        <option value="<?= $tb_umkm['id_kecamatan'] ?>"><?= $tb_umkm['kecamatan'] ?></option>
                    ...
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Latitude</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="latitude" required="" value="<?=$tb_umkm['latitude'] ?>" name="latitude">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Longitude</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" required="" id="longitude" value="<?=$tb_umkm['longitude'] ?>" name="longitude">
                            <div class="invalid-feedback">
